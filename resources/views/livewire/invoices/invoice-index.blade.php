                        ...
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="px-4 py-3 text-right">
                                <div class="flex justify-end items-center gap-2.5">
                                    ...
                                    <button type="button"
                                        onclick="window.downloadPdfInvoice('{{ route('invoices.download', ['invoice' => $invoice, 'filename' => 'Invoice-' . $invoice->invoice_number . '.pdf'], false) }}', 'Invoice-{{ $invoice->invoice_number }}.pdf')"
